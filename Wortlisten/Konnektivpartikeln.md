...
2. contrast (opposing or limiting statements)
   • [[aber]] – but
   ...
   • [[indes]] / indessen – meanwhile, however
   • [[jedoch]] – however
...
3. cause & effect (reasoning, consequences)
   • [[also]] – so, thus
   • [[aufgrund]] dessen – due to that
   • [[daher]] – hence
   • [[darum]] – that’s why
   • [[deshalb]] – therefore
   • [[deswegen]] – that’s why
...
4. condition (setting conditions or restrictions)
   • [[ansonsten]] – otherwise
...
6. concession (acknowledging counterpoints)
   • [[abgesehen davon, dass]] – apart from the fact that
   • [[auch wenn]] – even if
   • [[freilich]] – of course, admittedly
...
9. alternative choices & exclusion
...
10. summarization & conclusion
    ...
    • [[fazit ist, dass]] … – the bottom line is that …
...
this should be about as exhaustive as it gets. if you need a specific subset or want more examples in context, let me know.
