    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let r of ht(t))
        !gt.call(e, r) &&
          ...
          L(e, r, {
            get: () => t[r],
            enumerable: !(i = dt(t, r)) || i.enumerable,
          });
    return e;
  };
var ft = (e, t, n) => (
  ...
  _t = (e) => pe(L({}, "__esModule", { value: !0 }), e);
var nt = K((fi, tt) => {
  tt.exports = function (t, n) {
    if (
      (typeof t == "string" || t instanceof String) &&
      typeof document != "undefined"
    ) {
      var i = document.createElement("DIV");
      (i.innerHTML = t), (t = (i.textContent || "").trim());
    } else
      typeof t == "object" &&
        t.textContent &&
...
var it = K((oe) => {
  oe.endsWithChar = function (t, n) {
    return n.length > 1 ? n.indexOf(t.slice(-1)) > -1 : t.slice(-1) === n;
  };
  oe.endsWith = function (t, n) {
    return t.slice(t.length - n.length) === n;
  };
});
var rt = K((k) => {
  var ue,
  ...
  k.setAbbreviations = function (e) {
    e ? (ue = e) : (ue = sn);
  };
  var le = (k.isCapitalized = function (e) {
    return /^[A-Z][a-z].*/.test(e) || an(e);
  });
  k.isSentenceStarter = function (e) {
    return le(e) || /``|"|'/.test(e.substring(0, 2));
  };
  k.isCommonAbbreviation = function (e) {
    var t = e.replace(/[-'`~!@#$%^&*()_|+=?;:'",.<>\{\}\[\]\\\/]/gi, "");
    return ~ue.indexOf(t);
  };
  k.isTimeAbbreviation = function (e, t) {
    if (e === "a.m." || e === "p.m.") {
      var n = t.replace(/\W+/g, "").slice(-3).toLowerCase();
      if (n === "day") return !0;
    }
    return !1;
  };
  k.isDottedAbbreviation = function (e) {
    var t = e.replace(/[\(\)\[\]\{\}]/g, "").match(/(.\.)*/);
    return t && t[0].length > 0;
  };
  k.isCustomAbbreviation = function (e) {
    return e.length <= 3 ? !0 : le(e);
  };
  k.isNameAbbreviation = function (e, t) {
    if (t.length > 0) {
      if (e < 5 && t[0].length < 6 && le(t[0])) return !0;
  ...
  var an = (k.isNumber = function (e, t) {
    return t && (e = e.slice(t - 1, t + 2)), !isNaN(e);
  });
  k.isPhoneNr = function (e) {
    return e.match(
  ...
  k.isConcatenated = function (e) {
    ...
    if (
      ...
      var n = e.charAt(t + 1);
      if (n.match(/[a-zA-Z].*/)) return [e.slice(0, t), e.slice(t + 1)];
    }
    return !1;
  };
  k.isBoundaryChar = function (e) {
    return e === "." || e === "!" || e === "?";
  };
});
var ot = K((at) => {
  ...
  at.sentences = function (e, t) {
    ...
    if (typeof t == "boolean") n.newline_boundaries = !0;
    else for (var i in t) n[i] = t[i];
    if (
      (w.setAbbreviations(n.abbreviations),
      n.newline_boundaries && (e = e.replace(ln, ce)),
      n.html_boundaries)
    ) {
      var r = "(<br\\s*\\/?>|<\\/(" + n.html_boundaries_tags.join("|") + ")>)",
        a = new RegExp(r, "g");
      e = e.replace(a, "$1" + ce);
    }
    (n.sanitize || n.allowed_tags) &&
      (n.allowed_tags || (n.allowed_tags = [""]),
      (e = on(e, { allowedTags: n.allowed_tags })));
    var s, o;
    n.preserve_whitespace
      ? ((o = e.split(/(<br\s*\/?>|\S+|\n+)/)),
        (s = o.filter(function (v, C) {
          return C % 2;
        })))
      : (s = e.trim().match(cn));
    var c = 0,
    ...
    for (var u = 0, m = s.length; u < m; u++) {
      if (
        ...
        d.push(s[u]),
        ~s[u].indexOf(",") && (c = 0),
        w.isBoundaryChar(s[u]) || B.endsWithChar(s[u], "?!") || s[u] === st)
      ) {
        (n.newline_boundaries || n.html_boundaries) && s[u] === st && d.pop(),
          h.push(d),
          (c = 0),
          (d = []);
        continue;
      ...
      if (
        ((B.endsWithChar(s[u], '"') || B.endsWithChar(s[u], "\u201D")) &&
          (s[u] = s[u].slice(0, -1)),
        B.endsWithChar(s[u], "."))
      ) {
        if (u + 1 < m) {
          if (
            (s[u].length === 2 && isNaN(s[u].charAt(0))) ||
            w.isCommonAbbreviation(s[u])
          )
            continue;
          if (w.isSentenceStarter(s[u + 1])) {
            if (
              w.isTimeAbbreviation(s[u], s[u + 1]) ||
              w.isNameAbbreviation(c, s.slice(u, 6)) ||
              (w.isNumber(s[u + 1]) && w.isCustomAbbreviation(s[u]))
            )
              continue;
          } else if (
            B.endsWith(s[u], "..") ||
            w.isDottedAbbreviation(s[u]) ||
            w.isNameAbbreviation(c, s.slice(u, 5))
          )
            continue;
        }
        h.push(d), (d = []), (c = 0);
    ...
    var z = h.slice(1).reduce(
      function (v, C) {
        var E = v[v.length - 1];
        return E.length === 1 && /^.{1,2}[.]$/.test(E[0]) && !/[.]/.test(C[0])
          ? (v.pop(), v.push(E.concat(C)), v)
          : (v.push(C), v);
      },
      [h[0]]
    );
    return z.map(function (v, C) {
      if (
        n.preserve_whitespace &&
        !n.newline_boundaries &&
        !n.html_boundaries
      ) {
        var E = v.length * 2;
        return C === 0 && (E += 1), o.splice(0, E).join("");
      }
      return v.join(" ");
    });
  };
...
var dn = {};
mt(dn, { default: () => Z });
module.exports = _t(dn);
var X = require("obsidian");
var N = require("obsidian"),
  H = class extends N.PluginSettingTab {
    constructor(n, i) {
      super(n, i);
      this.plugin = i;
    }
    display() {
      ...
      n.empty(),
        new N.Setting(n).setName("API key").setHeading(),
        new N.Setting(n)
...
var ge = { deepseekApiKey: "", googleApiKey: "", apiProvider: "google" };
var me;
(function (e) {
  (e.STRING = "string"),
    (e.NUMBER = "number"),
...
var we = ["user", "model", "function", "system"],
  ve;
(function (e) {
...
var f = class extends Error {
  ...
  S = class extends f {},
  V = class extends f {};
var wt = "https://generativelanguage.googleapis.com",
  vt = "v1beta",
  bt = "0.24.0",
  xt = "genai-js",
  R;
...
async function yt(e) {
  ...
  n.append("Content-Type", "application/json"),
    n.append("x-goog-api-client", kt(e.requestOptions)),
  ...
  if (i) {
    ...
    for (let [r, a] of i.entries()) {
      if (r === "x-goog-api-key")
        throw new S(`Cannot set reserved header name ${r}`);
...
async function Et(e, t, n, i, r, a) {
  let s = new Q(e, t, n, i, a);
  return {
    url: s.toString(),
    fetchOptions: Object.assign(Object.assign({}, At(a)), {
      method: "POST",
      headers: await yt(s),
      body: r,
    }),
...
async function P(e, t, n, i, r, a = {}, s = fetch) {
  let { url: o, fetchOptions: c } = await Et(e, t, n, i, r, a);
  return zt(o, c, s);
}
async function zt(e, t, n = fetch) {
  let i;
  try {
    i = await n(e, t);
  } catch (r) {
...
function Ct(e, t) {
  ...
  throw (
    (n.name === "AbortError"
      ...
      : e instanceof W ||
        e instanceof S ||
        ((n = new f(`Error fetching from ${t.toString()}: ${e.message}`)),
        (n.stack = e.stack)),
    n)
  );
}
...
function Ce(e) {
  ...
  if (
    ...
    for (let s of (r =
      ...
      ? void 0
      : r.parts)
      s.functionCall && a.push(s.functionCall);
  if (a.length > 0) return a;
}
var Tt = [O.RECITATION, O.SAFETY, O.LANGUAGE];
function U(e) {
  return !!e.finishReason && Tt.includes(e.finishReason);
}
function I(e) {
  var t, n, i;
  let r = "";
  if ((!e.candidates || e.candidates.length === 0) && e.promptFeedback)
    ...
    let a = e.candidates[0];
    U(a) &&
      ((r += `Candidate was blocked due to ${a.finishReason}`),
      a.finishMessage && (r += `: ${a.finishMessage}`));
  }
  return r;
}
function M(e) {
...
function Nt(e, t, n) {
  ...
  function h(d, u) {
    d(u), a.shift(), a.length && o(a[0][0], a[0][1]);
  }
}
var Se = /^data\: (.*)(?:\n\n|\r\r|\r\n\r\n)/;
function Rt(e) {
  let t = e.body.pipeThrough(new TextDecoderStream("utf8", { fatal: !0 })),
    n = Dt(t),
    [i, r] = n.tee();
  return { stream: Mt(i), response: Ot(r) };
}
async function Ot(e) {
  let t = [],
    n = e.getReader();
  for (;;) {
    let { done: i, value: r } = await n.read();
    if (i) return te(Ft(t));
    t.push(r);
  }
}
function Mt(e) {
  return Nt(this, arguments, function* () {
    let n = e.getReader();
    for (;;) {
      let { value: i, done: r } = yield M(n.read());
      if (r) break;
      yield yield M(te(i));
    }
  });
        ...
        return t
          ...
          .catch((s) => {
            ...
            throw (
              ((o.stack = s.stack),
              o.name === "AbortError"
                ? (o = new V("Request aborted when reading from the stream"))
...
function Ft(e) {
  ...
  for (let i of e) {
    if (i.candidates) {
      let r = 0;
      for (let a of i.candidates)
        if (
          (n.candidates || (n.candidates = []),
          n.candidates[r] || (n.candidates[r] = { index: r }),
          (n.candidates[r].citationMetadata = a.citationMetadata),
          (n.candidates[r].groundingMetadata = a.groundingMetadata),
          (n.candidates[r].finishReason = a.finishReason),
          (n.candidates[r].finishMessage = a.finishMessage),
          (n.candidates[r].safetyRatings = a.safetyRatings),
          a.content && a.content.parts)
        ) {
          ...
          for (let o of a.content.parts)
            o.text && (s.text = o.text),
              ...
              Object.keys(s).length === 0 && (s.text = ""),
              n.candidates[r].content.parts.push(s);
        }
      r++;
    }
...
async function Re(e, t, n, i) {
  let r = await P(t, R.STREAM_GENERATE_CONTENT, e, !0, JSON.stringify(n), i);
  return Rt(r);
}
async function Oe(e, t, n, i) {
  let a = await (
    await P(t, R.GENERATE_CONTENT, e, !1, JSON.stringify(n), i)
  ).json();
  return { response: te(a) };
}
function Me(e) {
  if (e != null) {
...
function Ae(e) {
  let t;
  return (
    e.contents ? (t = e) : (t = { contents: [D(e)] }),
    e.systemInstruction && (t.systemInstruction = Me(e.systemInstruction)),
    t
  );
}
function Bt(e) {
...
function Gt(e) {
  ...
  for (let n of e) {
    ...
    for (let o of r) for (let c of Ie) c in o && (a[c] += 1);
    let s = jt[i];
    for (let o of Ie)
      if (!s.includes(o) && a[o] > 0)
...
function Te(e) {
  ...
  let n = (t = e.candidates[0]) === null || t === void 0 ? void 0 : t.content;
  ...
  ee = class {
    constructor(t, n, i, r = {}) {
      (this.model = n),
        ...
        (this._apiKey = t),
        i != null && i.history && (Gt(i.history), (this._history = i.history));
    }
    async getHistory() {
    ...
    async sendMessage(t, n = {}) {
      ...
      let p = D(t),
        g = {
          ...
          toolConfig:
            (s = this.params) === null || s === void 0 ? void 0 : s.toolConfig,
          systemInstruction:
        ...
        h = Object.assign(Object.assign({}, this._requestOptions), n),
        d;
      return (
        (this._sendPromise = this._sendPromise
          .then(() => Oe(this._apiKey, this.model, g, h))
          .then((u) => {
            var m;
            if (Te(u.response)) {
              ...
              this._history.push(z);
            } else {
              let z = I(u.response);
              z &&
                console.warn(
                  `sendMessage() was unsuccessful. ${z}. Inspect response object for details.`
                );
            }
            d = u;
          })),
    ...
    async sendMessageStream(t, n = {}) {
      ...
      let p = D(t),
        ...
        h = Object.assign(Object.assign({}, this._requestOptions), n),
        d = Re(this._apiKey, this.model, g, h);
      return (
        (this._sendPromise = this._sendPromise
          .then(() => d)
          .catch((u) => {
...
async function Lt(e, t, n, i) {
  return (await P(t, R.COUNT_TOKENS, e, !1, JSON.stringify(n), i)).json();
}
async function Kt(e, t, n, i) {
  return (await P(t, R.EMBED_CONTENT, e, !1, JSON.stringify(n), i)).json();
}
async function Ht(e, t, n, i) {
  let r = n.requests.map((s) =>
    Object.assign(Object.assign({}, s), { model: t })
  );
  return (
    await P(
      t,
      R.BATCH_EMBED_CONTENTS,
      e,
      !1,
...
var Y = class {
  constructor(t, n, i = {}) {
    (this.apiKey = t),
      ...
      (this.systemInstruction = Me(n.systemInstruction)),
  ...
  async countTokens(t, n = {}) {
    ...
    return Lt(this.apiKey, this.model, i, r);
  }
  async embedContent(t, n = {}) {
    let i = Bt(t),
      r = Object.assign(Object.assign({}, this._requestOptions), n);
    return Kt(this.apiKey, this.model, i, r);
  }
  async batchEmbedContents(t, n = {}) {
    let i = Object.assign(Object.assign({}, this._requestOptions), n);
    return Ht(this.apiKey, this.model, t, i);
  }
};
var F = class {
  constructor(t) {
  ...
  getGenerativeModel(t, n) {
    ...
    return new Y(this.apiKey, t, n);
  }
  getGenerativeModelFromCachedContent(t, n, i) {
    if (!t.name) throw new S("Cached content must contain a `name` field.");
    if (!t.model) throw new S("Cached content must contain a `model` field.");
    let r = ["model", "systemInstruction"];
    for (let s of r)
      if (n != null && n[s] && t[s] && (n == null ? void 0 : n[s]) !== t[s]) {
        if (s === "model") {
          let o = n.model.startsWith("models/")
        ...
        throw new S(
          `Different value for "${s}" specified in modelParams (${n[s]}) and cachedContent (${t[s]})`
        );
      }
...
async function Be(e, t, n) {
  try {
    await e.process(t, (i) => i + n);
  } catch (i) {
    throw (console.error(`Failed to append to file ${t.path}: ${i}`), i);
  }
}
async function je(e, t, n) {
  try {
    return (await e.read(t)).includes(n);
  } catch (i) {
    return console.error(`Failed to check file content ${t.path}: ${i}`), null;
  }
}
  ...
  try {
    ...
    if (t.path) {
      ...
      let i = t.name.trim(),
        ...
        s = r.slice(0, 3),
        o = r[3],
        c = (0, b.normalizePath)(`Worter/Ordered/${a}/${s}/${o}`);
      console.log("folderPath before", c);
      let p = await Le(e, c);
      console.log("folderPath after", p, p == null ? void 0 : p.path);
      let g = i.replace(/[\\/:*?"<>|]/g, "");
      n = `${p.path}/${g}.md`;
      let h = (0, b.normalizePath)(n);
      return await Ut(e, h);
    }
  } catch (n) {
    new b.Notice(`Error creating file ${t.name}: ${n.message}`);
  }
  return null;
}
async function Le(e, t) {
  let n = t.split("/").filter(Boolean),
    ...
    r = e.getRoot();
  for (let a of n) {
    i = (0, b.normalizePath)(`${i}/${a}`);
    let s = e.getAbstractFileByPath(i);
    if (s instanceof b.TFolder) r = s;
    else {
      if (s) throw new Error(`Cannot create folder: file exists at ${i}`);
      try {
  ...
  if (!r) throw new Error(`Failed to create or retrieve folder at ${t}`);
  return r;
}
async function Ut(e, t, n = "") {
  ...
  let a = i.split("/").slice(0, -1).join("/");
  await Le(e, a);
  try {
    await e.create(i, n);
  } catch (s) {
    if (!s.message.includes("already exists")) throw s;
  }
...
<examples>`;
var Ue = `<assistant_role>You are an advanced linguistic assistant specializing in German syntax and grammar. Your task is to generate structured Markdown-formatted konjugation/deklination table entries for a given German word, following a precise syntax notation.</assistant_role>
<instructions>
...
var y = {
  ...
  normalize: Pe,
  translate_de_to_eng: $e,
  keymaker: De,
  generate_valence_block: He,
};
var J = class {
  constructor(t, n) {
    this.settings = t;
    ...
    try {
      ...
      new Je.Notice(`Error initializing API service: ${i.message}`);
    }
  }
  async generateContent(t, n, i) {
    let r = performance.now();
    try {
      let a = null;
      if (
        ((t = t.replace(/^\t+/gm, "")), this.settings.apiProvider !== "google")
      )
      ...
      return (
        (a = (await this.chatSessions[o].sendMessage(n)).response.text()),
        a === null ? "" : a
      );
    } catch (a) {
  ...
  async fetchTemplate(t) {
    let [n, i] = await Promise.all([
      this.generateContent(y.generate_dictionary_entry, t),
      this.generateContent(y.generate_valence_block, t),
    ]);
    return `${n.replace("<agent_output>", "").replace("</agent_output>", "")}

---
${i}`;
  }
  async determineInfinitiveAndEmoji(t) {
    return this.generateContent(y.determine_infinitive_and_pick_emoji, t);
  }
  async normalize(t) {
    return this.generateContent(y.normalize, t);
  }
  async translateText(t) {
    return this.generateContent(y.translate_de_to_eng, t);
  }
  async consultKeymaker(t) {
    return this.generateContent(y.keymaker, t);
  }
  async consultC1Richter(t) {
    return this.generateContent(y.c1Richter, t);
  }
};
var $ = require("obsidian"),
  q = class {
    ...
    async readFileContentByPath(t) {
      try {
        let n = this.vault.getAbstractFileByPath(t);
        return !n || !(n instanceof $.TFile)
          ? { content: "", error: !0 }
          : { content: await this.vault.read(n), error: !1 };
      } catch (n) {
        return { content: "", error: !0 };
      }
    }
    async replaceContentInCurrentlyOpenedFile(t, n) {
      try {
        let i = this.app.workspace.getActiveViewOfType($.MarkdownView);
        if (!i)
          return console.warn("file not open or not active"), { error: !0 };
        let r = i.file;
        return !r || r.path !== t
          ? (console.warn("file not open or not active"), { error: !0 })
          : (i.editor.setValue(n), await i.save(), { error: !1 });
      } catch (i) {
        return console.error(`Failed to replace content: ${i}`), { error: !0 };
      }
    }
    async writeToOpenedFile(t, n) {
      var r;
      let i = this.app.workspace.getActiveViewOfType($.MarkdownView);
      if (
        i &&
        i != null &&
        i.file &&
        ((r = i == null ? void 0 : i.file) == null ? void 0 : r.path) === t
      ) {
        let a = i == null ? void 0 : i.editor;
        a && a.replaceRange(n, { line: a.lineCount(), ch: 0 });
      }
    }
    showLoadingOverlay() {
      if (document.getElementById("fileService-loading-overlay")) return;
      let t = document.createElement("div");
      t.id = "fileService-loading-overlay";
    ...
    hideLoadingOverlay() {
      let t = document.getElementById("fileService-loading-overlay");
      t && t.remove();
    }
  };
...
function en(e) {
  ...
  return i
    ? e.slice(0, i + 1) +
        `(https://youglish.com/pronounce/${n}/german)` +
        e.slice(i + 1)
    : e;
}
async function tn(e) {
...
`
    ...
    return console.error("Failed to read clipboard:", t), e;
  }
}
async function ie(e, t, n, i) {
  let r = n.basename;
  try {
    let [a, s, o, c] = await Promise.all([
        e.apiService.generateContent(y.generate_dictionary_entry, r),
        e.apiService.generateContent(y.generate_forms, r),
        e.apiService.generateContent(y.morphems, r),
        e.apiService.generateContent(y.generate_valence_block, r),
      ]),
      p = rn(s),
      g = `${a.replace("<agent_output>", "").replace("</agent_output>", "")}`,
      h = await tn(en(g)),
      d =
        o.replace(
          `
...
`,
          ...
          ? ""
          : `${p}`,
      C = [h, d, u, m, z].filter(Boolean).join(`
---
`),
      E = Ze(h);
    (E == null ? void 0 : E.toLocaleLowerCase()) === r.toLocaleLowerCase()
      ? await e.fileService.writeToOpenedFile(n.path, C)
      : (await e.fileService.writeToOpenedFile(n.path, `[[${E}]]`),
        await navigator.clipboard.writeText(C));
  } catch (a) {
    new qe.Notice(`Error: ${a.message}`);
  }
}
function nn(e) {
  let t = e.match(
...
function rn(e) {
  ...
  let n = ["er", "es", "e", "en", "em"],
    i = [];
  for (let r of t) for (let a of n) i.push(`[[${r + a}]]`);
  return i.join(", ");
}
...
async function se(e, t, n, i) {
  try {
    ...
    r && t.replaceSelection(r);
  } catch (r) {
    new Qe.Notice(`Error: ${r.message}`);
  }
}
...
async function ae(e, t, n) {
  try {
    let i = t.getCursor(),
      r = await e.apiService.translateText(n);
    r &&
      (t.replaceSelection(
        n +
          `
...
`
      ...
      t.setCursor({ line: i.line, ch: i.ch + n.length }));
  } catch (i) {
    new et.Notice(`Error: ${i.message}`);
  }
}
var ut = ft(ot());
async function de(e, t, n, i) {
  ...
  try {
    let s = t.getValue(),
      c = e.findHighestNumber(s) + 1,
      p = "";
    if (a.length <= 2) p = ne(i, r, c);
    else {
      let g = [];
...
`);
    ...
    await navigator.clipboard.writeText(`${p}`), t.replaceSelection(`${p}`);
  } catch (s) {
    console.error("Error formatting selection with number:", s);
  }
}
var j = require("obsidian");
async function he(e, t, n, i, r) {
  var a;
  try {
    let s = i.getFileCache(e),
      o = (a = s == null ? void 0 : s.links) != null ? a : [],
      c = new Set(o.map(({ link: g }) => g)),
      p = [];
    for (let g of c) {
      let h = i.getFirstLinkpathDest(g, e.path);
      h instanceof j.TFile
    ...
    for (let g of p)
      try {
        ...
        if (!h) continue;
        let d = `[[${t}]]`;
        (await je(n, h, d)) || (await Be(n, h, `, ${d}`));
      } catch (h) {
        new j.Notice(`Error processing link ${g.name}: ${h.message}`);
      }
    r.refresh();
  } catch (s) {
    new j.Notice("Error processing backlinks");
  }
}
function lt(e) {
  return e
...
async function G(e, t, n) {
  try {
    let i = await e.apiService.consultC1Richter(lt(n));
    i &&
      t.replaceSelection(
        n +
          `
...
var Z = class extends X.Plugin {
  async onload() {
    try {
      await this.loadPlugin(), this.addSettingTab(new H(this.app, this));
    } catch (n) {
      console.error("Error during plugin initialization:", n),
        new X.Notice(`Plugin failed to load: ${n.message}`);
    }
  }
  async loadPlugin() {
    await this.loadSettings(),
      (this.apiService = new J(this.settings, this.app.vault)),
      (this.fileService = new q(this.app, this.app.vault)),
      this.addCommand({
        id: "backlink-all-to-current-file",
        name: "Populate all referenced files with a backlink to the current file",
        editorCheckCallback: (n, i, r) => {
          var o, c;
          let a = (o = r.file) == null ? void 0 : o.name,
            s = (c = r.file) == null ? void 0 : c.basename;
          return r.file && a && s
            ? (n || he(r.file, s, this.app.vault, this.app.metadataCache, i),
              !0)
            : !1;
        },
      }),
      ...
      this.addCommand({
        ...
        editorCheckCallback: (n, i, r) => {
          ...
          return a && r.file ? (n || se(this, i, r.file, a), !0) : !1;
        },
      }),
      this.addCommand({
        id: "translate-selection",
        name: "Translate selected text",
        editorCheckCallback: (n, i) => {
          let r = i.getSelection();
          return r ? (n || ae(this, i, r), !0) : !1;
        },
      }),
      this.addCommand({
        ...
        editorCheckCallback: (n, i, r) => {
          let a = i.getSelection();
          return a && r.file ? (n || de(this, i, r.file, a), !0) : !1;
        },
      }),
      this.addCommand({
