...
var en=Object.create;var P=Object.defineProperty;var nn=Object.getOwnPropertyDescriptor;var tn=Object.getOwnPropertyNames;var rn=Object.getPrototypeOf,sn=Object.prototype.hasOwnProperty;var K=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),an=(e,n)=>{for(var t in n)P(e,t,{get:n[t],enumerable:!0})},ce=(e,n,t,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let r of tn(n))!sn.call(e,r)&&r!==t&&P(e,r,{get:()=>n[r],enumerable:!(i=nn(n,r))||i.enumerable});return e};var on=(e,n,t)=>(t=e!=null?en(rn(e)):{},ce(n||!e||!e.__esModule?P(t,"default",{value:e,enumerable:!0}):t,e)),un=e=>ce(P({},"__esModule",{value:!0}),e);var Ve=K((ni,Ue)=>{Ue.exports=function(n,t){if((typeof n=="string"||n instanceof String)&&typeof document!="undefined"){var i=document.createElement("DIV");i.innerHTML=n,n=(i.textContent||"").trim()}else typeof n=="object"&&n.textContent&&(n=(n.textContent||"").trim());return n}});var Ye=K(ie=>{ie.endsWithChar=function(n,t){return t.length>1?t.indexOf(n.slice(-1))>-1:n.slice(-1)===t};ie.endsWith=function(n,t){return n.slice(n.length-t.length)===t}});var Je=K(v=>{var re,Un=["al","adj","assn","Ave","BSc","MSc","Cell","Ch","Co","cc","Corp","Dem","Dept","ed","eg","Eq","Eqs","est","est","etc","Ex","ext","Fig","fig","Figs","figs","i.e","ie","Inc","inc","Jan","Feb","Mar","Apr","Jun","Jul","Aug","Sep","Sept","Oct","Nov","Dec","jr","mi","Miss","Mrs","Mr","Ms","Mol","mt","mts","no","Nos","PhD","MD","BA","MA","MM","pl","pop","pp","Prof","Dr","pt","Ref","Refs","Rep","repr","rev","Sec","Secs","Sgt","Col","Gen","Rep","Sen","Gov","Lt","Maj","Capt","St","Sr","sr","Jr","jr","Rev","Sun","Mon","Tu","Tue","Tues","Wed","Th","Thu","Thur","Thurs","Fri","Sat","trans","Univ","Viz","Vol","vs","v"];v.setAbbreviations=function(e){e?re=e:re=Un};var se=v.isCapitalized=function(e){return/^[A-Z][a-z].*/.test(e)||Vn(e)};v.isSentenceStarter=function(e){return se(e)||/``|"|'/.test(e.substring(0,2))};v.isCommonAbbreviation=function(e){var n=e.replace(/[-'`~!@#$%^&*()_|+=?;:'",.<>\{\}\[\]\\\/]/gi,"");return~re.indexOf(n)};v.isTimeAbbreviation=function(e,n){if(e==="a.m."||e==="p.m."){var t=n.replace(/\W+/g,"").slice(-3).toLowerCase();if(t==="day")return!0}return!1};v.isDottedAbbreviation=function(e){var n=e.replace(/[\(\)\[\]\{\}]/g,"").match(/(.\.)*/);return n&&n[0].length>0};v.isCustomAbbreviation=function(e){return e.length<=3?!0:se(e)};v.isNameAbbreviation=function(e,n){if(n.length>0){if(e<5&&n[0].length<6&&se(n[0]))return!0;var t=n.filter(function(i){return/[A-Z]/.test(i.charAt(0))});return t.length>=3}return!1};var Vn=v.isNumber=function(e,n){return n&&(e=e.slice(n-1,n+2)),!isNaN(e)};v.isPhoneNr=function(e){return e.match(/^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$/)};v.isURL=function(e){return e.match(/[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/)};v.isConcatenated=function(e){var n=0;if((n=e.indexOf("."))>-1||(n=e.indexOf("!"))>-1||(n=e.indexOf("?"))>-1){var t=e.charAt(n+1);if(t.match(/[a-zA-Z].*/))return[e.slice(0,n),e.slice(n+1)]}return!1};v.isBoundaryChar=function(e){return e==="."||e==="!"||e==="?"}});var Xe=K(Ze=>{var Yn=Ve(),F=Ye(),_=Je(),ae=" @~@ ",qe=ae.trim(),Jn=new RegExp("\\S",""),qn=new RegExp("\\n+|[-#=_+*]{4,}","g"),Zn=new RegExp("\\S+|\\n","g");Ze.sentences=function(e,n){if(!e||typeof e!="string"||!e.length)return[];if(!Jn.test(e))return[];var t={newline_boundaries:!1,html_boundaries:!1,html_boundaries_tags:["p","div","ul","ol"],sanitize:!1,allowed_tags:!1,preserve_whitespace:!1,abbreviations:null};if(typeof n=="boolean")t.newline_boundaries=!0;else for(var i in n)t[i]=n[i];if(_.setAbbreviations(t.abbreviations),t.newline_boundaries&&(e=e.replace(qn,ae)),t.html_boundaries){var r="(<br\\s*\\/?>|<\\/("+t.html_boundaries_tags.join("|")+")>)",a=new RegExp(r,"g");e=e.replace(a,"$1"+ae)}(t.sanitize||t.allowed_tags)&&(t.allowed_tags||(t.allowed_tags=[""]),e=Yn(e,{allowedTags:t.allowed_tags}));var s,u;t.preserve_whitespace?(u=e.split(/(<br\s*\/?>|\S+|\n+)/),s=u.filter(function(f,k){return k%2})):s=e.trim().match(Zn);var l=0,d=0,h=[],g=[],c=[];if(!s||!s.length)return[];for(var o=0,p=s.length;o<p;o++){if(l++,c.push(s[o]),~s[o].indexOf(",")&&(l=0),_.isBoundaryChar(s[o])||F.endsWithChar(s[o],"?!")||s[o]===qe){(t.newline_boundaries||t.html_boundaries)&&s[o]===qe&&c.pop(),g.push(c),l=0,c=[];continue}if((F.endsWithChar(s[o],'"')||F.endsWithChar(s[o],"\u201D"))&&(s[o]=s[o].slice(0,-1)),F.endsWithChar(s[o],".")){if(o+1<p){if(s[o].length===2&&isNaN(s[o].charAt(0))||_.isCommonAbbreviation(s[o]))continue;if(_.isSentenceStarter(s[o+1])){if(_.isTimeAbbreviation(s[o],s[o+1])||_.isNameAbbreviation(l,s.slice(o,6))||_.isNumber(s[o+1])&&_.isCustomAbbreviation(s[o]))continue}else if(F.endsWith(s[o],"..")||_.isDottedAbbreviation(s[o])||_.isNameAbbreviation(l,s.slice(o,5)))continue}g.push(c),c=[],l=0;continue}(d=s[o].indexOf("."))>-1&&(_.isNumber(s[o],d)||_.isDottedAbbreviation(s[o])||_.isURL(s[o])||_.isPhoneNr(s[o]))||(h=_.isConcatenated(s[o]))&&(c.pop(),c.push(h[0]),g.push(c),c=[],l=0,c.push(h[1]))}c.length&&g.push(c),g=g.filter(function(f){return f.length>0});var x=g.slice(1).reduce(function(f,k){var T=f[f.length-1];return T.length===1&&/^.{1,2}[.]$/.test(T[0])&&!/[.]/.test(k[0])?(f.pop(),f.push(T.concat(k)),f):(f.push(k),f)},[g[0]]);return x.map(function(f,k){if(t.preserve_whitespace&&!t.newline_boundaries&&!t.html_boundaries){var T=f.length*2;return k===0&&(T+=1),u.splice(0,T).join("")}return f.join(" ")})}});var Xn={};an(Xn,{default:()=>V});module.exports=un(Xn);var Y=require("obsidian");var S=require("obsidian"),B=class extends S.PluginSettingTab{constructor(t,i){super(t,i);this.plugin=i}display(){let{containerEl:t}=this;t.empty(),new S.Setting(t).setName("API configuration").setHeading(),new S.Setting(t).setName("Gemini API key").setDesc("Enter your Gemini API key").addText(i=>i.setPlaceholder("Enter your API key").setValue(this.plugin.settings.googleApiKey).onChange(async r=>{this.plugin.settings.googleApiKey=r,await this.plugin.saveSettings()})),new S.Setting(t).setName("DeepSeek API key").setDesc("Enter your DeepSeek API key").addText(i=>i.setPlaceholder("Enter your API key").setValue(this.plugin.settings.deepseekApiKey).onChange(async r=>{this.plugin.settings.deepseekApiKey=r,await this.plugin.saveSettings()})),new S.Setting(t).setName("API provider").setDesc("Choose your API provider").addDropdown(i=>{i.addOption("google","Google").addOption("deepseek","DeepSeek").setValue(this.plugin.settings.apiProvider).onChange(async r=>{this.plugin.settings.apiProvider=r,await this.plugin.saveSettings()})})}};var de={deepseekApiKey:"",googleApiKey:"",apiProvider:"google"};var he;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(he||(he={}));var ge;(function(e){e.LANGUAGE_UNSPECIFIED="language_unspecified",e.PYTHON="python"})(ge||(ge={}));var pe;(function(e){e.OUTCOME_UNSPECIFIED="outcome_unspecified",e.OUTCOME_OK="outcome_ok",e.OUTCOME_FAILED="outcome_failed",e.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded"})(pe||(pe={}));var me=["user","model","function","system"],fe;(function(e){e.HARM_CATEGORY_UNSPECIFIED="HARM_CATEGORY_UNSPECIFIED",e.HARM_CATEGORY_HATE_SPEECH="HARM_CATEGORY_HATE_SPEECH",e.HARM_CATEGORY_SEXUALLY_EXPLICIT="HARM_CATEGORY_SEXUALLY_EXPLICIT",e.HARM_CATEGORY_HARASSMENT="HARM_CATEGORY_HARASSMENT",e.HARM_CATEGORY_DANGEROUS_CONTENT="HARM_CATEGORY_DANGEROUS_CONTENT"})(fe||(fe={}));var _e;(function(e){e.HARM_BLOCK_THRESHOLD_UNSPECIFIED="HARM_BLOCK_THRESHOLD_UNSPECIFIED",e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_ONLY_HIGH="BLOCK_ONLY_HIGH",e.BLOCK_NONE="BLOCK_NONE"})(_e||(_e={}));var we;(function(e){e.HARM_PROBABILITY_UNSPECIFIED="HARM_PROBABILITY_UNSPECIFIED",e.NEGLIGIBLE="NEGLIGIBLE",e.LOW="LOW",e.MEDIUM="MEDIUM",e.HIGH="HIGH"})(we||(we={}));var ve;(function(e){e.BLOCKED_REASON_UNSPECIFIED="BLOCKED_REASON_UNSPECIFIED",e.SAFETY="SAFETY",e.OTHER="OTHER"})(ve||(ve={}));var N;(function(e){e.FINISH_REASON_UNSPECIFIED="FINISH_REASON_UNSPECIFIED",e.STOP="STOP",e.MAX_TOKENS="MAX_TOKENS",e.SAFETY="SAFETY",e.RECITATION="RECITATION",e.LANGUAGE="LANGUAGE",e.OTHER="OTHER"})(N||(N={}));var be;(function(e){e.TASK_TYPE_UNSPECIFIED="TASK_TYPE_UNSPECIFIED",e.RETRIEVAL_QUERY="RETRIEVAL_QUERY",e.RETRIEVAL_DOCUMENT="RETRIEVAL_DOCUMENT",e.SEMANTIC_SIMILARITY="SEMANTIC_SIMILARITY",e.CLASSIFICATION="CLASSIFICATION",e.CLUSTERING="CLUSTERING"})(be||(be={}));var ke;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.AUTO="AUTO",e.ANY="ANY",e.NONE="NONE"})(ke||(ke={}));var xe;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.MODE_DYNAMIC="MODE_DYNAMIC"})(xe||(xe={}));var m=class extends Error{constructor(n){super(`[GoogleGenerativeAI Error]: ${n}`)}},E=class extends m{constructor(n,t){super(n),this.response=t}},G=class extends m{constructor(n,t,i,r){super(n),this.status=t,this.statusText=i,this.errorDetails=r}},y=class extends m{};var ln="https://generativelanguage.googleapis.com",cn="v1beta",dn="0.21.0",hn="genai-js",A;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.EMBED_CONTENT="embedContent",e.BATCH_EMBED_CONTENTS="batchEmbedContents"})(A||(A={}));var J=class{constructor(n,t,i,r,a){this.model=n,this.task=t,this.apiKey=i,this.stream=r,this.requestOptions=a}toString(){var n,t;let i=((n=this.requestOptions)===null||n===void 0?void 0:n.apiVersion)||cn,a=`${((t=this.requestOptions)===null||t===void 0?void 0:t.baseUrl)||ln}/${i}/${this.model}:${this.task}`;return this.stream&&(a+="?alt=sse"),a}};function gn(e){let n=[];return e!=null&&e.apiClient&&n.push(e.apiClient),n.push(`${hn}/${dn}`),n.join(" ")}async function pn(e){var n;let t=new Headers;t.append("Content-Type","application/json"),t.append("x-goog-api-client",gn(e.requestOptions)),t.append("x-goog-api-key",e.apiKey);let i=(n=e.requestOptions)===null||n===void 0?void 0:n.customHeaders;if(i){if(!(i instanceof Headers))try{i=new Headers(i)}catch(r){throw new y(`unable to convert customHeaders value ${JSON.stringify(i)} to Headers: ${r.message}`)}for(let[r,a]of i.entries()){if(r==="x-goog-api-key")throw new y(`Cannot set reserved header name ${r}`);if(r==="x-goog-api-client")throw new y(`Header name ${r} can only be set using the apiClient field`);t.append(r,a)}}return t}async function mn(e,n,t,i,r,a){let s=new J(e,n,t,i,a);return{url:s.toString(),fetchOptions:Object.assign(Object.assign({},vn(a)),{method:"POST",headers:await pn(s),body:r})}}async function M(e,n,t,i,r,a={},s=fetch){let{url:u,fetchOptions:l}=await mn(e,n,t,i,r,a);return fn(u,l,s)}async function fn(e,n,t=fetch){let i;try{i=await t(e,n)}catch(r){_n(r,e)}return i.ok||await wn(i,e),i}function _n(e,n){let t=e;throw e instanceof G||e instanceof y||(t=new m(`Error fetching from ${n.toString()}: ${e.message}`),t.stack=e.stack),t}async function wn(e,n){let t="",i;try{let r=await e.json();t=r.error.message,r.error.details&&(t+=` ${JSON.stringify(r.error.details)}`,i=r.error.details)}catch(r){}throw new G(`Error fetching from ${n.toString()}: [${e.status} ${e.statusText}] ${t}`,e.status,e.statusText,i)}function vn(e){let n={};if((e==null?void 0:e.signal)!==void 0||(e==null?void 0:e.timeout)>=0){let t=new AbortController;(e==null?void 0:e.timeout)>=0&&setTimeout(()=>t.abort(),e.timeout),e!=null&&e.signal&&e.signal.addEventListener("abort",()=>{t.abort()}),n.signal=t.signal}return n}function Z(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),j(e.candidates[0]))throw new E(`${z(e)}`,e);return bn(e)}else if(e.promptFeedback)throw new E(`Text not available. ${z(e)}`,e);return""},e.functionCall=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),j(e.candidates[0]))throw new E(`${z(e)}`,e);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),ye(e)[0]}else if(e.promptFeedback)throw new E(`Function call not available. ${z(e)}`,e)},e.functionCalls=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),j(e.candidates[0]))throw new E(`${z(e)}`,e);return ye(e)}else if(e.promptFeedback)throw new E(`Function call not available. ${z(e)}`,e)},e}function bn(e){var n,t,i,r;let a=[];if(!((t=(n=e.candidates)===null||n===void 0?void 0:n[0].content)===null||t===void 0)&&t.parts)for(let s of(r=(i=e.candidates)===null||i===void 0?void 0:i[0].content)===null||r===void 0?void 0:r.parts)s.text&&a.push(s.text),s.executableCode&&a.push("\n```"+s.executableCode.language+`
`+s.executableCode.code+"\n```\n"),s.codeExecutionResult&&a.push("\n```\n"+s.codeExecutionResult.output+"\n```\n");return a.length>0?a.join(""):""}function ye(e){var n,t,i,r;let a=[];if(!((t=(n=e.candidates)===null||n===void 0?void 0:n[0].content)===null||t===void 0)&&t.parts)for(let s of(r=(i=e.candidates)===null||i===void 0?void 0:i[0].content)===null||r===void 0?void 0:r.parts)s.functionCall&&a.push(s.functionCall);if(a.length>0)return a}var kn=[N.RECITATION,N.SAFETY,N.LANGUAGE];function j(e){return!!e.finishReason&&kn.includes(e.finishReason)}function z(e){var n,t,i;let r="";if((!e.candidates||e.candidates.length===0)&&e.promptFeedback)r+="Response was blocked",!((n=e.promptFeedback)===null||n===void 0)&&n.blockReason&&(r+=` due to ${e.promptFeedback.blockReason}`),!((t=e.promptFeedback)===null||t===void 0)&&t.blockReasonMessage&&(r+=`: ${e.promptFeedback.blockReasonMessage}`);else if(!((i=e.candidates)===null||i===void 0)&&i[0]){let a=e.candidates[0];j(a)&&(r+=`Candidate was blocked due to ${a.finishReason}`,a.finishMessage&&(r+=`: ${a.finishMessage}`))}return r}function R(e){return this instanceof R?(this.v=e,this):new R(e)}function xn(e,n,t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var i=t.apply(e,n||[]),r,a=[];return r={},s("next"),s("throw"),s("return"),r[Symbol.asyncIterator]=function(){return this},r;function s(c){i[c]&&(r[c]=function(o){return new Promise(function(p,x){a.push([c,o,p,x])>1||u(c,o)})})}function u(c,o){try{l(i[c](o))}catch(p){g(a[0][3],p)}}function l(c){c.value instanceof R?Promise.resolve(c.value.v).then(d,h):g(a[0][2],c)}function d(c){u("next",c)}function h(c){u("throw",c)}function g(c,o){c(o),a.shift(),a.length&&u(a[0][0],a[0][1])}}var Ee=/^data\: (.*)(?:\n\n|\r\r|\r\n\r\n)/;function yn(e){let n=e.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0})),t=Cn(n),[i,r]=t.tee();return{stream:zn(i),response:En(r)}}async function En(e){let n=[],t=e.getReader();for(;;){let{done:i,value:r}=await t.read();if(i)return Z(Sn(n));n.push(r)}}function zn(e){return xn(this,arguments,function*(){let t=e.getReader();for(;;){let{value:i,done:r}=yield R(t.read());if(r)break;yield yield R(Z(i))}})}function Cn(e){let n=e.getReader();return new ReadableStream({start(i){let r="";return a();function a(){return n.read().then(({value:s,done:u})=>{if(u){if(r.trim()){i.error(new m("Failed to parse stream"));return}i.close();return}r+=s;let l=r.match(Ee),d;for(;l;){try{d=JSON.parse(l[1])}catch(h){i.error(new m(`Error parsing JSON response: "${l[1]}"`));return}i.enqueue(d),r=r.substring(l[0].length),l=r.match(Ee)}return a()})}}})}function Sn(e){let n=e[e.length-1],t={promptFeedback:n==null?void 0:n.promptFeedback};for(let i of e){if(i.candidates)for(let r of i.candidates){let a=r.index;if(t.candidates||(t.candidates=[]),t.candidates[a]||(t.candidates[a]={index:r.index}),t.candidates[a].citationMetadata=r.citationMetadata,t.candidates[a].groundingMetadata=r.groundingMetadata,t.candidates[a].finishReason=r.finishReason,t.candidates[a].finishMessage=r.finishMessage,t.candidates[a].safetyRatings=r.safetyRatings,r.content&&r.content.parts){t.candidates[a].content||(t.candidates[a].content={role:r.content.role||"user",parts:[]});let s={};for(let u of r.content.parts)u.text&&(s.text=u.text),u.functionCall&&(s.functionCall=u.functionCall),u.executableCode&&(s.executableCode=u.executableCode),u.codeExecutionResult&&(s.codeExecutionResult=u.codeExecutionResult),Object.keys(s).length===0&&(s.text=""),t.candidates[a].content.parts.push(s)}}i.usageMetadata&&(t.usageMetadata=i.usageMetadata)}return t}async function Ae(e,n,t,i){let r=await M(n,A.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(t),i);return yn(r)}async function Ie(e,n,t,i){let a=await(await M(n,A.GENERATE_CONTENT,e,!1,JSON.stringify(t),i)).json();return{response:Z(a)}}function Te(e){if(e!=null){if(typeof e=="string")return{role:"system",parts:[{text:e}]};if(e.text)return{role:"system",parts:[e]};if(e.parts)return e.role?e:{role:"system",parts:e.parts}}}function O(e){let n=[];if(typeof e=="string")n=[{text:e}];else for(let t of e)typeof t=="string"?n.push({text:t}):n.push(t);return An(n)}function An(e){let n={role:"user",parts:[]},t={role:"function",parts:[]},i=!1,r=!1;for(let a of e)"functionResponse"in a?(t.parts.push(a),r=!0):(n.parts.push(a),i=!0);if(i&&r)throw new m("Within a single message, FunctionResponse cannot be mixed with other type of part in the request for sending chat message.");if(!i&&!r)throw new m("No content is provided for sending chat message.");return i?n:t}function In(e,n){var t;let i={model:n==null?void 0:n.model,generationConfig:n==null?void 0:n.generationConfig,safetySettings:n==null?void 0:n.safetySettings,tools:n==null?void 0:n.tools,toolConfig:n==null?void 0:n.toolConfig,systemInstruction:n==null?void 0:n.systemInstruction,cachedContent:(t=n==null?void 0:n.cachedContent)===null||t===void 0?void 0:t.name,contents:[]},r=e.generateContentRequest!=null;if(e.contents){if(r)throw new y("CountTokensRequest must have one of contents or generateContentRequest, not both.");i.contents=e.contents}else if(r)i=Object.assign(Object.assign({},i),e.generateContentRequest);else{let a=O(e);i.contents=[a]}return{generateContentRequest:i}}function ze(e){let n;return e.contents?n=e:n={contents:[O(e)]},e.systemInstruction&&(n.systemInstruction=Te(e.systemInstruction)),n}function Tn(e){return typeof e=="string"||Array.isArray(e)?{content:O(e)}:e}var Ce=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],Nn={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function Rn(e){let n=!1;for(let t of e){let{role:i,parts:r}=t;if(!n&&i!=="user")throw new m(`First content should be with role 'user', got ${i}`);if(!me.includes(i))throw new m(`Each item should include role field. Got ${i} but valid roles are: ${JSON.stringify(me)}`);if(!Array.isArray(r))throw new m("Content should have 'parts' property with an array of Parts");if(r.length===0)throw new m("Each Content should have at least one part");let a={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(let u of r)for(let l of Ce)l in u&&(a[l]+=1);let s=Nn[i];for(let u of Ce)if(!s.includes(u)&&a[u]>0)throw new m(`Content with role '${i}' can't contain '${u}' part`);n=!0}}var Se="SILENT_ERROR",q=class{constructor(n,t,i,r={}){this.model=t,this.params=i,this._requestOptions=r,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=n,i!=null&&i.history&&(Rn(i.history),this._history=i.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(n,t={}){var i,r,a,s,u,l;await this._sendPromise;let d=O(n),h={safetySettings:(i=this.params)===null||i===void 0?void 0:i.safetySettings,generationConfig:(r=this.params)===null||r===void 0?void 0:r.generationConfig,tools:(a=this.params)===null||a===void 0?void 0:a.tools,toolConfig:(s=this.params)===null||s===void 0?void 0:s.toolConfig,systemInstruction:(u=this.params)===null||u===void 0?void 0:u.systemInstruction,cachedContent:(l=this.params)===null||l===void 0?void 0:l.cachedContent,contents:[...this._history,d]},g=Object.assign(Object.assign({},this._requestOptions),t),c;return this._sendPromise=this._sendPromise.then(()=>Ie(this._apiKey,this.model,h,g)).then(o=>{var p;if(o.response.candidates&&o.response.candidates.length>0){this._history.push(d);let x=Object.assign({parts:[],role:"model"},(p=o.response.candidates)===null||p===void 0?void 0:p[0].content);this._history.push(x)}else{let x=z(o.response);x&&console.warn(`sendMessage() was unsuccessful. ${x}. Inspect response object for details.`)}c=o}),await this._sendPromise,c}async sendMessageStream(n,t={}){var i,r,a,s,u,l;await this._sendPromise;let d=O(n),h={safetySettings:(i=this.params)===null||i===void 0?void 0:i.safetySettings,generationConfig:(r=this.params)===null||r===void 0?void 0:r.generationConfig,tools:(a=this.params)===null||a===void 0?void 0:a.tools,toolConfig:(s=this.params)===null||s===void 0?void 0:s.toolConfig,systemInstruction:(u=this.params)===null||u===void 0?void 0:u.systemInstruction,cachedContent:(l=this.params)===null||l===void 0?void 0:l.cachedContent,contents:[...this._history,d]},g=Object.assign(Object.assign({},this._requestOptions),t),c=Ae(this._apiKey,this.model,h,g);return this._sendPromise=this._sendPromise.then(()=>c).catch(o=>{throw new Error(Se)}).then(o=>o.response).then(o=>{if(o.candidates&&o.candidates.length>0){this._history.push(d);let p=Object.assign({},o.candidates[0].content);p.role||(p.role="model"),this._history.push(p)}else{let p=z(o);p&&console.warn(`sendMessageStream() was unsuccessful. ${p}. Inspect response object for details.`)}}).catch(o=>{o.message!==Se&&console.error(o)}),c}};async function On(e,n,t,i){return(await M(n,A.COUNT_TOKENS,e,!1,JSON.stringify(t),i)).json()}async function Dn(e,n,t,i){return(await M(n,A.EMBED_CONTENT,e,!1,JSON.stringify(t),i)).json()}async function Mn(e,n,t,i){let r=t.requests.map(s=>Object.assign(Object.assign({},s),{model:n}));return(await M(n,A.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:r}),i)).json()}var W=class{constructor(n,t,i={}){this.apiKey=n,this._requestOptions=i,t.model.includes("/")?this.model=t.model:this.model=`models/${t.model}`,this.generationConfig=t.generationConfig||{},this.safetySettings=t.safetySettings||[],this.tools=t.tools,this.toolConfig=t.toolConfig,this.systemInstruction=Te(t.systemInstruction),this.cachedContent=t.cachedContent}async generateContent(n,t={}){var i;let r=ze(n),a=Object.assign(Object.assign({},this._requestOptions),t);return Ie(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(i=this.cachedContent)===null||i===void 0?void 0:i.name},r),a)}async generateContentStream(n,t={}){var i;let r=ze(n),a=Object.assign(Object.assign({},this._requestOptions),t);return Ae(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(i=this.cachedContent)===null||i===void 0?void 0:i.name},r),a)}startChat(n){var t;return new q(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(t=this.cachedContent)===null||t===void 0?void 0:t.name},n),this._requestOptions)}async countTokens(n,t={}){let i=In(n,{model:this.model,generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:this.cachedContent}),r=Object.assign(Object.assign({},this._requestOptions),t);return On(this.apiKey,this.model,i,r)}async embedContent(n,t={}){let i=Tn(n),r=Object.assign(Object.assign({},this._requestOptions),t);return Dn(this.apiKey,this.model,i,r)}async batchEmbedContents(n,t={}){let i=Object.assign(Object.assign({},this._requestOptions),t);return Mn(this.apiKey,this.model,n,i)}};var D=class{constructor(n){this.apiKey=n}getGenerativeModel(n,t){if(!n.model)throw new m("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new W(this.apiKey,n,t)}getGenerativeModelFromCachedContent(n,t,i){if(!n.name)throw new y("Cached content must contain a `name` field.");if(!n.model)throw new y("Cached content must contain a `model` field.");let r=["model","systemInstruction"];for(let s of r)if(t!=null&&t[s]&&n[s]&&(t==null?void 0:t[s])!==n[s]){if(s==="model"){let u=t.model.startsWith("models/")?t.model.replace("models/",""):t.model,l=n.model.startsWith("models/")?n.model.replace("models/",""):n.model;if(u===l)continue}throw new y(`Different value for "${s}" specified in modelParams (${t[s]}) and cachedContent (${n[s]})`)}let a=Object.assign(Object.assign({},t),{model:n.model,tools:n.tools,toolConfig:n.toolConfig,systemInstruction:n.systemInstruction,cachedContent:n});return new W(this.apiKey,a,i)}};var $=require("obsidian");var Ne=`<agent_role>You are a specialized linguist and a german language tutor with a specialy in German language. You will be given a german grammar exercise by the USER. Your taksk it to eather provide the solution for a task, or to check the USERS's solution </agent_role>
...
`;var Re=`Given a german word, determine it's normal form and pick an appropriate emoji to represent it. In this context, Partizip 1's normal from is an infinitive of a corresponding verb. If the word is a noun, determin it's gender and use \u{1F535} for der,  \u{1F534} for die, if \u{1F7E2} for das. Do not write anything else, just the infinitive and an emoji. 
...
"klares", -> "\u{1F60C} [[kl\xE4ren]] | \u{1F60C} [[klar]] | \u{1F7E2} das [[Klare]] \u{1F60C}.`;var Oe=`<assistant_role>You are an expert linguist specializing in the German language. Your task is to create a detailed dictionary entry for a normal form of a given German word, following a precise syntax notation.</assistant_role>
...
---
`),k=Hn(h);(k==null?void 0:k.toLocaleLowerCase())===r.toLocaleLowerCase()?await e.fileService.appendToFile(t.path,f):await e.fileService.appendToFile(t.path,`[[${k}]]`)}catch(a){new We.Notice(`Error: ${a.message}`)}}function Ln(e){let n=e.match(/Adjektive:\s*\[\[(.*?)\]\],\s*\[\[(.*?)\]\],\s*\[\[(.*?)\]\]/);if(!n)return null;let[t,i,r,a]=n;return[i,r,a]}function $n(e){let n=Ln(e);if(!n)return w;let t=["er","es","e","en","em"],i=[];for(let r of n)for(let a of t)i.push(`[[${r+a}]]`);return i.join(", ")}var He=require("obsidian");async function ee(e,n,t){let i=t.basename;try{let r=await e.apiService.determineInfinitiveAndEmoji(i);r&&(r=r.replace(/^\n+/,""),r=r.trim(),await e.fileService.appendToFile(t.path,r+`
`))}catch(r){new He.Notice(`Error: ${r.message}`)}}var Le=require("obsidian");async function ne(e,n,t,i){try{let r=await e.apiService.normalize(i);r&&n.replaceSelection(r)}catch(r){new Le.Notice(`Error: ${r.message}`)}}var $e=require("obsidian");async function te(e,n,t){try{let i=n.getCursor(),r=await e.apiService.translateText(t);r&&(n.replaceSelection(t+`

`+r+`
`),n.setCursor({line:i.line,ch:i.ch+t.length}))}catch(i){new $e.Notice(`Error: ${i.message}`)}}var Qe=on(Xe());async function oe(e,n,t,i){let r=t.basename,a=(0,Qe.sentences)(i,{preserve_whitespace:!1,newline_boundaries:!1,html_boundaries:!1,sanitize:!0});try{let s=n.getValue(),l=e.findHighestNumber(s)+1,d="";a.length<=2?d=X(i,r,l):d=a.map((h,g)=>X(h,r,l+g)).join(`
`),await navigator.clipboard.writeText(`${d}`),n.replaceSelection(`${d}`)}catch(s){console.error("Error formatting selection with number:",s)}}var C=require("obsidian");async function ue(e,n,t,i,r){var a;try{let s=i.getFileCache(e),u=(a=s==null?void 0:s.links)!=null?a:[];console.log("links",u);let l=[];for(let d of u){let h=d.link,g=i.getFirstLinkpathDest(h,e.path);g instanceof C.TFile?l.push({name:h,path:g.path}):l.push({name:h,path:null})}console.log("resolvedPaths",l);for(let d of l)try{let h,g=`[[${n}]]`;if(d.path)h=d.path;else{let o=d.name[0].toUpperCase(),p=(0,C.normalizePath)(`Worter/${o}`);t.getFolderByPath(p)||await t.createFolder(p),h=(0,C.normalizePath)(`${p}/${d.name}.md`)}console.log("filePath",h),await Fe(t,h,g)||await H(t,h,`, ${g}`)}catch(h){new C.Notice(`Error processing link ${d.name}: ${h.message}`)}r.refresh()}catch(s){new C.Notice(`Error processing backlinks: ${s.message}`)}}async function le(e,n,t){try{let i=await e.apiService.consultC1Richter(t);i&&n.replaceSelection(t+`
`+i+`
`)}catch(i){console.error("Error in C1 Richter command:",i)}}var V=class extends Y.Plugin{async onload(){try{await this.loadPlugin(),this.addSettingTab(new B(this.app,this))}catch(t){console.error("Error during plugin initialization:",t),new Y.Notice(`Plugin failed to load: ${t.message}`)}}async loadPlugin(){await this.loadSettings(),this.apiService=new L(this.settings,this.app.vault),this.fileService=new U(this.app.vault),this.addCommand({id:"backlink-all-to-current-file",name:"[P] All referenced files with a backlink to the current file",editorCheckCallback:(t,i,r)=>{var u,l;let a=(u=r.file)==null?void 0:u.name,s=(l=r.file)==null?void 0:l.basename;return console.log("view.file, fileName, backlink",r.file,a,s),r.file&&a&&s?(t||ue(r.file,s,this.app.vault,this.app.metadataCache,i),!0):!1}}),this.addCommand({id:"fill-template",name:"[G] Generate a dictionary entry for the word in the title of the file",editorCheckCallback:(t,i,r)=>r.file?(t||Q(this,i,r.file),!0):!1}),this.addCommand({id:"get-infinitive-and-emoji",name:"[I] [Redundant] Get infinitive/normal form and emoji for current word",editorCheckCallback:(t,i,r)=>r.file?(t||ee(this,i,r.file),!0):!1}),this.addCommand({id:"duplicate-selection",name:"[WIP] Add links to normal/inf forms to selected text",editorCheckCallback:(t,i,r)=>{let a=i.getSelection();return a&&r.file?(t||ne(this,i,r.file,a),!0):!1}}),this.addCommand({id:"translate-selection",name:"[D] Translate selecteD text",editorCheckCallback:(t,i)=>{let r=i.getSelection();return r?(t||te(this,i,r),!0):!1}}),this.addCommand({id:"format-selection-with-number",name:"[S] Split selection into linked blocks",editorCheckCallback:(t,i,r)=>{let a=i.getSelection();return a&&r.file?(t||oe(this,i,r.file,a),!0):!1}}),this.addCommand({id:"check-ru-de-translation",name:"[K] Keymaker",editorCheckCallback:(t,i)=>{let r=i.getSelection();return r?(t||le(this,i,r),!0):!1}})}async loadSettings(){this.settings=Object.assign({},de,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}findHighestNumber(t){let i=t.match(/#\^(\d+)/g);if(!i)return 0;let r=i.map(a=>{let s=a.replace("#^","");return parseInt(s,10)});return Math.max(0,...r)}};
