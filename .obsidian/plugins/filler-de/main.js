...
var b=Object.defineProperty;var x=Object.getOwnPropertyDescriptor;var C=Object.getOwnPropertyNames;var F=Object.prototype.hasOwnProperty;var I=(s,i)=>{for(var t in i)b(s,t,{get:i[t],enumerable:!0})},T=(s,i,t,e)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of C(i))!F.call(s,n)&&n!==t&&b(s,n,{get:()=>i[n],enumerable:!(e=x(i,n))||e.enumerable});return s};var P=s=>T(b({},"__esModule",{value:!0}),s);var j={};I(j,{default:()=>k});module.exports=P(j);var u=require("obsidian");var p=require("obsidian"),f=class extends p.PluginSettingTab{constructor(t,e){super(t,e);this.plugin=e}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"Settings"}),new p.Setting(t).setName("Anthropic API Key").setDesc("Won`t leave your vault").addText(e=>e.setPlaceholder("Enter your key").setValue(this.plugin.settings.anthropicKey).onChange(async n=>{this.plugin.settings.anthropicKey=n,await this.plugin.saveSettings()}))}};var v={anthropicKey:""};var w=require("obsidian");var h={generate_dictionary_entry:`You are the expert-linguist in German language. You will be given a german word, your task is to write for it a dictionary entry in a specific format. The comments in <...> are for you and are not part of the template.
