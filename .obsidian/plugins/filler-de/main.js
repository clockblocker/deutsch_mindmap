...
Depending on the form of a word, the templates differ. Do not respond with anyting, other then filled templates. Correct spelling, if nessessary. 

Given any non-infinitive form of a verb like [[bekommst]], start with:
'''
[bəˈkɔmst], inf: [[bekommen]]
'''
and the continue to fill the template for infinitiv
