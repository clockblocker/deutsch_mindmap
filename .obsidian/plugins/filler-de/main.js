...
var b=Object.defineProperty;var S=Object.getOwnPropertyDescriptor;var F=Object.getOwnPropertyNames;var P=Object.prototype.hasOwnProperty;var C=(s,i)=>{for(var t in i)b(s,t,{get:i[t],enumerable:!0})},I=(s,i,t,e)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of F(i))!P.call(s,n)&&n!==t&&b(s,n,{get:()=>i[n],enumerable:!(e=S(i,n))||e.enumerable});return s};var A=s=>I(b({},"__esModule",{value:!0}),s);var T={};C(T,{default:()=>k});module.exports=A(T);var u=require("obsidian");var p=require("obsidian"),m=class extends p.PluginSettingTab{constructor(t,e){super(t,e);this.plugin=e}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"Settings"}),new p.Setting(t).setName("Anthropic API Key").setDesc("Won`t leave your vault").addText(e=>e.setPlaceholder("Enter your key").setValue(this.plugin.settings.anthropicKey).onChange(async n=>{this.plugin.settings.anthropicKey=n,await this.plugin.saveSettings()}))}};var y={anthropicKey:""};var x=require("obsidian");var g={generate_dictionary_entry:`You are the expert-linguist in German language. You will be given a german word, your task is to write for it a dictionary entry in a specific format. 
...
</example>`};var h=class{constructor(i){this.settings=i}async fetchTemplate(i){return this.makeRequest(i,g.generate_dictionary_entry)}async determineInfinitiveAndEmoji(i){return this.makeRequest(i,g.determine_infinitive_and_pick_emoji)}async makeBrackets(i){return this.makeRequest(i,g.make_brackets)}async translateText(i){return this.makeRequest(i,g.translate_text)}async makeRequest(i,t){let e="https://api.anthropic.com/v1/messages",n={"Content-Type":"application/json","x-api-key":this.settings.anthropicKey,"anthropic-version":"2023-06-01"},a={model:"claude-3-5-haiku-20241022",max_tokens:1024,system:[{type:"text",text:t,cache_control:{type:"ephemeral"}}],messages:[{role:"user",content:i}]};try{let r=await(0,x.requestUrl)({url:e,method:"POST",contentType:"application/json",body:JSON.stringify(a),headers:n});return JSON.stringify(r)}catch(r){return r+`

`+JSON.stringify({url:e,method:"POST",headers:n,body:a})}}};var c=require("obsidian"),d=class{constructor(i){this.vault=i}async appendToFile(i,t){let e=this.vault.getAbstractFileByPath(i);if(!e){try{await this.vault.create(i,t)}catch(n){new c.Notice(`Error creating file: ${n.message}`)}return}if(!(e instanceof c.TFile)){new c.Notice(`File ${i} does not exist or is not a valid file!`);return}try{let a=await this.vault.read(e)+t;await this.vault.modify(e,a)}catch(n){new c.Notice(`Error appending to file: ${n.message}`)}}async doesFileContainContent(i,t){let e=this.vault.getAbstractFileByPath(i);return!e||!(e instanceof c.TFile)?null:(await this.vault.read(e)).includes(t)}};var w=s=>{let i=s.split("[[").map(t=>t.replace(/\\/g,"").split("|")[0].split("]]")[0]);return i.shift(),i};var k=class extends u.Plugin{async onload(){await this.loadSettings(),this.apiService=new h(this.settings),this.fileService=new d(this.app.vault),this.addCommand({id:"backlink-all-to-current-file",name:"Add backlinks to the current file in all referenced files",editorCallback:async(t,e)=>{var o;let n=(o=e.file)==null?void 0:o.name;if(!n){new u.Notice("Current file is missing a title");return}let a=e.data,r=w(a);for(let l of r){let f=`Worter/${l}.md`,v=`[[${n.split(".")[0]}]]`;await this.fileService.doesFileContainContent(f,v)||await this.fileService.appendToFile(f,`, ${v}`)}}}),this.addCommand({id:"fill-template",name:"Fill the template for the word in the title of the file",editorCallback:async(t,e)=>{var o,l;let n=(o=e.file)==null?void 0:o.name;if(!n){new u.Notice("Current file is missing a title");return}let a=await this.apiService.fetchTemplate(n),r=this.extractContentFromResponse(a);r&&((l=e==null?void 0:e.file)!=null&&l.path)&&await this.fileService.appendToFile(e.file.path,r)}}),this.addCommand({id:"get-infinitive-and-emoji",name:"Get infinitive form and emoji for current word",editorCallback:async(t,e)=>{var o,l;let n=(o=e.file)==null?void 0:o.name;if(!n){new u.Notice("Current file is missing a title");return}let a=await this.apiService.determineInfinitiveAndEmoji(n),r=this.extractContentFromResponse(a);r&&((l=e==null?void 0:e.file)!=null&&l.path)&&await this.fileService.appendToFile(e.file.path,r)}}),this.addCommand({id:"duplicate-selection",name:"Duplicate selected text and process with brackets",editorCallback:async t=>{let e=t.getSelection();if(e){let n=t.getCursor(),a=await this.apiService.makeBrackets(e),r=this.extractContentFromResponse(a);r&&(t.replaceSelection(e+`
